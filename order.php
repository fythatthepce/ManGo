...
<caption>
  	...
  	<div>
		...
		<a href="#" class="order-detail" data-id="<?php echo $data['order_id']; ?>" data-cust="<?php echo $data['cust_id']; ?>"></a>
 		<img src="<?php echo $img_pay; ?>"> การชำระเงิน  -
        <img src="<?php echo $img_delivery; ?>"> การจัดส่งสินค้า

 	</div>
</caption>
<tr><th>ชื่อ</th><th>นามสกุล</th><th>ที่อยู่</th><th>zone</th><th>ชื่อสินค้า</th><th>จำนวน</th><th>ราคา</th><th>รวม</th><th>ลบ</th><th>ขอรหัสขนส่ง</th></tr>
<?php
...
<tr>
    ...
    <script>
    function myFunction() {
      window.open('http://eggplant.ddns.net/thecarrier/mangothecarriercoop.php?namere=<?=($fname)?>&desre=<?=($faddress)?>&zonere=<?=($fzone)?>');
    }
    </script>
