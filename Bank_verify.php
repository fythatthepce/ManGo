...
<div class="container">
	...
	<div class="col-md-3 text-center">
		...
		<button type="button" class="btn btn-primary btn-lg"><a href ="http://bank.route.in.th:9999/user">The Real Bank</a></button>
	</div>
	<div class="col-md-2"></div>
	<div class="col-md-3 text-center">
		<img src="/imgBank/CeSeBank.png" style="width:auto;height:auto;"><br><br><br>
		<button type="button" class="btn btn-primary btn-lg"><a href ="http://161.246.70.75:8080/cesebank/Login.html">CESE Bank</a></button>
	</div>
	<div class="col-md-2"></div>
</div>
