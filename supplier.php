...
<caption>
	...
	<button id="add-sup" type="button" class="btn btn-success">เพิ่มผู้จัดส่งสินค้า</button>
</caption>
<colgroup><col id="c1"><col id="c2"><col id="c3"><col id="c4"><col id="c5"><col id="c6"></colgroup>
<tr><th>ลำดับ</th><th>ชื่อผู้จัดส่งสินค้า</th><th>ที่อยู่</th><th>โทร</th><th>บุคคลในการติดต่อ</th></tr>
<?php
$row = $first;
